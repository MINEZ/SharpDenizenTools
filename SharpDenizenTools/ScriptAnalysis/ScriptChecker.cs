...
namespace SharpDenizenTools.ScriptAnalysis
{
    ...
    public class ScriptChecker
    {
        ...
        public static readonly Dictionary<string, KnownScriptType> KnownScriptTypes = new()
        {
            ...
            { "dialog", new KnownScriptType() { RequiredKeys = ["base"], LikelyBadKeys = ["script", "actions", "steps", "events"], ValueKeys = ["definitions", "bodies.*", "inputs.*"], ListKeys = ["dialogs"], ScriptKeys = ["procedural", "base.*", "buttons.*", "yes.*", "no.*", "button.*"], Strict = true, CanHaveRandomScripts = false } },
